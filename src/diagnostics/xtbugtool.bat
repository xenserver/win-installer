...
reg export "HKLM\SYSTEM\CurrentControlSet\Services\xenbus_monitor" "%bugpath%\registry\xenbus_monitor.reg" /y > NUL 2>&1
reg export "HKLM\SYSTEM\CurrentControlSet\Services\xeagent" "%bugpath%\registry\xenagent.reg" /y > NUL 2>&1
