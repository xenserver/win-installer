...
namespace XSToolsInstallation
{
    public static class Device
    {
        ...
        public static int FindInRegistry(
        ...
        public static void RemoveFromRegistry(string[] hwIDs, bool strictSearch)
        {
            ...
            FindInRegistry(ref devices, hwIDs, deviceInfoSet, strictSearch);
            ...
            for (int i = 0; i < devices.Length; ++i)
            {
                ...
                {
                    excMsg = String.Format(
                        "Unable to set class install params for hardware device: {0}",
                        hwIDs[i]
                    );
                ...
                {
                    excMsg = String.Format(
                        "Unable to call class installer for hardware device: {0}",
                        hwIDs[i]
                    );
            ...
            PInvoke.SetupApi.SetupDiDestroyDeviceInfoList(deviceInfoSet);
